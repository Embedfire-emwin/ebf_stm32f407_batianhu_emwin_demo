...
#define 	COLOR_RED_TIM_FORCED_CONFIG_FUN			TIM_ForcedOC1Config		//通道使能、关闭函数
...
#define 	COLOR_GREEN_TIM_FORCED_CONFIG_FUN			TIM_ForcedOC1Config		//通道使能、关闭函数
...
#define 	COLOR_BLUE_TIM_FORCED_CONFIG_FUN			TIM_ForcedOC1Config		//通道使能、关闭函数
