...
MP3DecInfo  mp3DecInfo __EXRAM;     //  0x7f0 =  2032 
SubbandInfo sbi  __EXRAM;            // 0x2204 =  8708
IMDCTInfo mi __EXRAM;               // 0x1b20 =  6944
HuffmanInfo hi __EXRAM;             // 0x1210 =  4624
DequantInfo di __EXRAM;             //  0x348 =   840
ScaleFactorInfo sfi __EXRAM;        //  0x124 =   292
SideInfo si __EXRAM;                //  0x148 =   328
FrameHeader fh __EXRAM;             //   0x38 =    56
#else
#include "mem.h"
//#define malloc
//#define free
