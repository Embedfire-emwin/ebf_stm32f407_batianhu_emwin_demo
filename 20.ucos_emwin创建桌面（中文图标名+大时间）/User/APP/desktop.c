...
static const BITMAP_ITEM _aBitmapItem[] = 
{
  ...
  {&bmCompass,          "\xe7\xbd\x97\xe7\x9b\x98"},  
	...
	{&bmSafari, 		       "\xe6\xb5\x8f\xe8\xa7\x88\xe5\x99\xa8"}, 
...
//	WM_HWIN hItem;
	...
	switch (pMsg->MsgId) 
	{
		...
		case WM_PAINT:		
			...
			GUI_DispStringHCenterAt("11:56",TIMEWIN_xSize/2,25);
...
static void CreateTimeWin(void)
{
	 ...
	 WM_CreateWindowAsChild(	TIMEWIN_xPos,											
															TIMEWIN_yPos,
															TIMEWIN_xSize,
															TIMEWIN_ySize,	
															WM_HBKWIN, 
															WM_CF_STAYONTOP|WM_CF_SHOW|WM_CF_MEMDEV,
															_cbTimeWin, 
															0
															);
