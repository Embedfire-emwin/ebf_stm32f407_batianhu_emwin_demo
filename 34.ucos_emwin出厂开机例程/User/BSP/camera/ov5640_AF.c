...
//  写入自动对焦固件 Brust mode
    OV5640_WriteFW((uint8_t *)OV5640_AF_FW,totalCnt);
...
//{
//	 uint8_t state;
//   state = OV5640_FOCUS_AD5820_Init();
//	
//	if(state ==0)
//	{
//   return OV5640_FOCUS_AD5820_Constant_Focus();
//	}
//	else
//		return state;
//}
