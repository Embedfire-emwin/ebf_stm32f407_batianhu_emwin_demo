...
static const BITMAP_ITEM _aBitmapItem[] = 
{
  ...
  {&bmPhotos,   	      "\xe5\x9b\xbe\xe7\x89\x87"},		
	...
	{&bmwifi,   	      "WiFi"},		
	{&bmDrawing,  	      "\xe7\xbb\x98\xe7\x94\xbb"},   	
	{&bmSystem,    			"\xe7\xb3\xbb\xe7\xbb\x9f"}, 
#endif
};
...
uint8_t ICON_Clicked[17]   = {0};   /* ICONVIEW控件按下的标志，0表示未按下，1表示按下 */
...
//					sec    =  rtc_time.RTC_Time.RTC_Seconds;
					...
					sprintf(text_buffer,"%02d:%02d",hour,min);
...
//	GUI_SetColor(GUI_BLACK);
  ...
  FRAMEWIN_SetDefaultClientColor(APPBKCOLOR);//APPBKCOLOR
