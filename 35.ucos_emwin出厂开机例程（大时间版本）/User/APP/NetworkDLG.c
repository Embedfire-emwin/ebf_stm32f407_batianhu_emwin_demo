...
static const GUI_WIDGET_CREATE_INFO _aDialogCreateNetwork[] = {
  ...
  { MULTIEDIT_CreateIndirect, "SendBuf",      GUI_ID_MULTIEDIT0, 10,  260, 480-30, 240, 0, 0x0,  0 },
  { MULTIEDIT_CreateIndirect, "ReceiveBuf",   GUI_ID_MULTIEDIT1, 	10, 540,  480-30, 250, 0, 0x0,  0 },
  { BUTTON_CreateIndirect,    "Clear",        GUI_ID_BUTTON2,    200, 505, 90,  32,  0, 0x0,  0 },
  { BUTTON_CreateIndirect,    "Send",         GUI_ID_BUTTON1,    200, 225,  90,  32,  0, 0x0,  0 },
...
void FUN_ICON6Clicked(void) 
{
  ...
  hNetMemory = GUI_ALLOC_AllocZero(COMDATA_SIZE);
  comdata = GUI_ALLOC_h2p(hNetMemory);
